            ...
            <div className="max-w-7xl mx-auto">
                <div className="mb-6">
                    <Space direction="vertical" size="small">
                        ...
                        <Title level={2} className="!mb-0">Create New Service</Title>
                        <p className="text-gray-600">Create a new laptop service request</p>
                    </Space>
                </div>
                ...
                >
                    <Row gutter={24}>
                        ...
                        <Col xs={24} lg={8}>
                            <div className="space-y-6">
                                <Card title="Service Images" className="shadow-sm h-full">
